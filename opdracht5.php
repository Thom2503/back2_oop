<?php
  ...
  echo "Er zit nu ".$auto1->benzine." liter benzine in de tank.</p>";

  echo "<h3>40 Liter tanken in auto 2</h3>";
  $verspild = $auto2->tanken(40);
  echo "<p> Er is ".$verspild." liter benzine verspild<br>";
  echo "Er zit nu ".$auto2->benzine." liter benzine in de tank.</p>";

  echo "<h3>80 Liter tanken in auto 3</h3>";
  $verspild = $auto3->tanken(80);
  echo "<p> Er is ".$verspild." liter benzine verspild<br>";
  echo "Er zit nu ".$auto3->benzine." liter benzine in de tank.</p>";
